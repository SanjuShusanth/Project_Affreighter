...
with col3:
    ...
    shipment_terms = st.selectbox("Select Shipment Terms (Incoterms):", incoterms, help="Choose an Incoterm to see detailed explanation below.")
    st.info(incoterm_expenses[shipment_terms])
