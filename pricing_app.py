...
with col3:
    ...
    st.markdown("<span style=;'color:black;'font-weight: 500;'>Select Shipment Terms (Incoterms): <span style='font-size: 18px; color: #007bff;'>&#9432;</span></span>", unsafe_allow_html=True)
